# SPD-Response-Time-YoY-Dashboard
SPD Response Time YoY Dashboard using publicly available SPD call data.


Steps are as follows: 
1. For data please refer to: https://data.seattle.gov/Public-Safety/Call-Data/33kz-ixgy/about_data
